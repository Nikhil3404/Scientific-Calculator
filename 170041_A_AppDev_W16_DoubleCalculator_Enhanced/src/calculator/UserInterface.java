...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Label label_DoubleCalculator = new Label("Enhanced Double Calculator");
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		text_Operand1.setOnAction((event) -> { 
			Double i = Double.parseDouble(text_Operand1.getText());
			if(i>1e7){
				
				
				text_Operand1.setText(Double.toString(i));
			}
			if(i<1e7){
				text_Operand1.setText(Double.toString(i));
			}
		...
		text_Operand2.setOnAction((event) -> { 
			Double i = Double.parseDouble(text_Operand2.getText());
			if(i>1e7){
				text_Operand2.setText(Double.toString(i));
			}
			if(i<1e7){
				text_Operand2.setText(Double.toString(i));
			}
